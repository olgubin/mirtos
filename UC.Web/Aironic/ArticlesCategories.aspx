                    ...
                    <tr>
                        ...
                        <td style="padding: 0px;">
                            <div class="departmenttitle">
                                <asp:HyperLink runat="server" ID="lnkCatTitle" Text='<%# Eval("Title") %>' NavigateUrl='<%# "Articles.aspx?CatID=" + Eval("ID") %>' /><%--ForeColor="#d7c5ab"--%><%--<asp:HyperLink runat="server" ID="lnkCatRss" NavigateUrl='<%# "GetArticlesRss.aspx?CatID=" + Eval("ID") %>'>&nbsp<img style="border-width: 0px;" src="Images/rss.gif" alt="RSS лента этой категории" /></asp:HyperLink>--%></div>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding: 0px;">
