<%@ Page Language="C#" MasterPageFile="~/Template.master" AutoEventWireup="true"
    CodeFile="Error.aspx.cs" Inherits="UC.UI.Error" Culture="auto" UICulture="auto" %>
...
<%--        <p>
        ...
        <center>
            <mb:ContactForm ID="ContactForm" runat="server" Title="Мы будем благодарны, если Вы сообщите нам о действиях, при которых появилась ошибка:"
                DefaultName="ErrorFromUser" DefaultEmail="info@С-СLIMATE.RU" DefaultSubject="Сообщение об ошибке от пользователя"
                ShowFieldCaption="false" />
        </center>--%>
        <mb:Departments ID="Departments" runat="server" RepeatColumns="2" MainReferencePage="DepartmentBrowse.aspx" ReferencePage="BrowseProducts.aspx"/>
