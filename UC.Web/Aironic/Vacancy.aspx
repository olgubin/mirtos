...
<asp:Content ID="MainContent" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div id="content">
        <p>
            <b>ООО «Сити-Климат»</b> - поставки систем вентиляции и кондиционирования, отопительных 
        ...
        <p >
            <b>Тел.: (495) 730-78-18</b></p>
        <b>E-mail: <a href="mailto:info@mirtos.ru">info@mirtos.ru</a></b>
        <br />
        <br />
        <br />
    </div>
