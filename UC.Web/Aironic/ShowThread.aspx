<%@ Page Language="C#" MasterPageFile="~/Template.master" AutoEventWireup="true" CodeFile="ShowThread.aspx.cs" Inherits="UC.UI.ShowThread" Title="The Beer House - Thread: {0}" %>
<%@ Import Namespace="UC" %>
...
<asp:Content ID="MainContent" ContentPlaceHolderID="MainContent" Runat="Server">
   ...
   <asp:ObjectDataSource ID="objPosts" runat="server" DeleteMethod="DeletePost" SelectMethod="GetThreadByID" SelectCountMethod="GetPostCountByThread"
      TypeName="UC.BLL.Forums.Post" EnablePaging="true">
      <DeleteParameters>
