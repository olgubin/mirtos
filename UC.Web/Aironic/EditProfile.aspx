...
<asp:Content ID="MainContent" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div id="content">
        ...
        <table width="100%">
            <tr>
                <td style="width: 50%;">
                     <mb:UserProfile ID="UserProfile1" runat="server" From="info@С-СLIMATE.RU" FromCaption="Климатическое оборудование С-СLIMATE.RU" BodyFileName="~/ChangeProfileMail.txt" Subject="Изменение регистрационных данных"/>
                </td>
                <td style="width: 50%">
                    <table width="100%">
                        <tr style="background-color: #c5b6a8">
                        ...
                        <tr>
                            <td>
                            <mb:ChangePassword runat="server" From="info@С-СLIMATE.RU" FromCaption="Климатическое оборудование С-СLIMATE.RU" BodyFileName="~/ChangePasswordMail.txt" Subject="Изменение пароля"/>
                            </td>
                        </tr>
                    </table>
                </td>
