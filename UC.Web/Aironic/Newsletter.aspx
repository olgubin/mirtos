<%@ Page Language="C#" MasterPageFile="~/Template.master" ValidateRequest="false"
    AutoEventWireup="true" CodeFile="Newsletter.aspx.cs" Inherits="UC.UI.ShowNewsletter" %>
...
<asp:Content ID="MainContent" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div id="content">
        ...
        <asp:Label runat="server" ID="lblAddedDate" ForeColor="#d7c5ab" Font-Size="Smaller" />
