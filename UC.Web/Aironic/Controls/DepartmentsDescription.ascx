                ...
                <tr>
                    ...
                    <td>
                        <div class="departmenttitle">
                            <asp:HyperLink runat="server" ID="lnkDepTitle" Text='<%# Eval("Name") %>' NavigateUrl='<%# "~/BrowseProducts.aspx?DepID=" + Eval("DepartmentID") %>' /></div>
                        <div class="departmentdescription">
                            <asp:HyperLink runat="server" ID="HyperLink1" Text='<%# Eval("Description") %>' NavigateUrl='<%# "~/BrowseProducts.aspx?DepID=" + Eval("DepartmentID") %>' /></div>
                    </td>
                </tr>
            </table>
        </ItemTemplate>
