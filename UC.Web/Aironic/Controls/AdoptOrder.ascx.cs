    ...
    public partial class AdoptOrder : System.Web.UI.UserControl
    {
        ...
        public void Generate()
        {
            if (Page.User.Identity.IsAuthenticated)
            {
                ...
                formTxt += "<p>Благодарим Вас за заказ в интернет-магазине <b style=\"color: #d7c5ab\">AIRONIC.RU</b>!</p><p>Номер Вашего заказа: ";
                userMsg += "<p>Благодарим Вас за заказ в интернет-магазине <b style=\"color: #d7c5ab\">AIRONIC.RU</b>!</p><p>Номер Вашего заказа: ";
                mainMsg += "<p>Заказ № ";
                ...
                prim = prim + "</p>";
                prim = prim + "<p>Вопросы, связанные с заказами, а также предложения и пожелания по работе магазина и службы доставки Вы можите направлять по адресу: <a href=\"mailto:zakaz@aironic.ru\">zakaz@aironic.ru</a>. Для нас важно знать Ваше мнение!</p><p><b style=\"color: #d7c5ab\">Спасибо, что Вы выбрали нас!</b></p>";
                ...
                body = String.Format(body, "DP-02437 от " + DateTime.Now.ToString("D"), products, (this.Page as BasePage).FormatPrice(this.Profile.ShoppingCart.Total));

                lblAdopt.Text = formTxt + body + prim + "<p style=\"text-align:left\">Служба заказов интернет-магазина <b style=\"color: #d7c5ab\">AIRONIC.RU</b>.</p>";
                ...
                userMsg = "<p>Здравствуйте, " + user.Comment + "!</p>" + userMsg + body + prim + "<p>С уважением,<br/>администрация магазина AIRONIC.RU <br/>+7 (495) 730-78-18<br/>WWW.AIRONIC.RU</p>";
                mainMsg += body + "<p>Тепловое оборудование AIRONIC.RU <br/>+7 (495) 730-78-18<br/>www.AIRONIC.RU</p>";
                try
                {
                    SmtpClient client = new SmtpClient();
                    MailMessage message = new MailMessage();
                    message.From = new MailAddress("zakaz@aironic.ru", "Тепловое оборудование AIRONIC.RU", System.Text.Encoding.UTF8);
                    message.IsBodyHtml = true;
                    message.Subject = "Заказ № " + "DP-02437 от " + DateTime.Now.ToString("D");
