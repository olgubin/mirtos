        ...
        <asp:Repeater runat="server" ID="repManufacturers">
            ...
            <ItemTemplate>
                <tr>
                    <td>
                        <div>
                            <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# "~/BrowseProducts.aspx?ManID="+Eval("ManufacturerID") %>'
        ...
        <asp:Repeater runat="server" ID="repManufacturers1">
            ...
            <ItemTemplate>
                <tr>
                    <td>
                       <div id="article">                    
                            <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# "~/BrowseProducts.aspx?ManID="+Eval("ID") %>' ToolTip='<%# Eval("Title") %>'>
                                <asp:Image ID="Image2" runat="Server" ImageUrl='<%# "~/manimage.aspx?ManID="+Eval("ID") %>' />
                            </asp:HyperLink>
                            <div style="padding-top:12px">
                                <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl='<%# "~/BrowseProducts.aspx?ManID="+Eval("ID") %>' Font-Underline="false"
                                    ToolTip='<%# Eval("Title") %>'><%# Eval("Title") %></asp:HyperLink><br />
                            </div>
                       </div>
                    </td>
