...
<asp:Content ID="MainContent" runat="server" ContentPlaceHolderID="MainContent">
    <div class="breadcrumb">
        <table>
            <tr>
                <td>
                    <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/Default.aspx" EnableViewState="false">Главная</asp:HyperLink></td>
                <td>
...
<%--        <asp:Panel runat="server" ID="panModerator">
        ...
        <asp:Panel runat="server" ID="panStatistics">
            <div class="sectionsubtitle">
                <asp:Literal ID="Literal6" runat="server" Text="Статистика" /></div>
            <ul style="list-style-type: square">
...
<%--        <asp:Panel runat="server" ID="panParsing">
            <div class="sectionsubtitle">
                <asp:Literal ID="Literal10" runat="server" Text="Парсинг каталогов" /></div>
            <ul style="list-style-type: square">
                <li><a href="ManageParsingCatalogs.aspx">
                    <asp:Literal ID="Literal12" runat="server" Text="Управление внешними каталогами" /></a>
                    <asp:Literal ID="Literal13" runat="server" Text=": добавление, удаление, изменение внешних каталогов с которых нужно получать информацию о товарах." />
                </li>
            </ul>
        </asp:Panel>--%>          
