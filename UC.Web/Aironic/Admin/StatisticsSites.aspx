...
<asp:Content ID="MainContent" ContentPlaceHolderID="MainContent" runat="Server">
    <div class="breadcrumb">
        <table>
            <tr>
                ...
                <td><h1>Статистика приходов с других сайтов</h1></td>
            </tr>
        </table>
    </div>
    <div id="content">
    <p>Показывает с каких сайтов приходили пользователи. Позволяет оценить цитируемость нашего сайта, что является одним из ключевых показателей, учитываемых поисковыми системами.</p>
    <asp:Label runat="server" ID="lblFiltr" ForeColor="#d7c5ab" Font-Bold="true"/>
            ...
            <asp:GridView ID="gvwSites" runat="server" AllowPaging="true" AutoGenerateColumns="False"
                DataKeyNames="IP" AllowSorting="true" EmptyDataText="<b>Нет данных</b>" OnRowDataBound="gvwSites_RowDataBound" Width="100%">
                <Columns>
                    ...
                    <asp:BoundField HeaderText="Пользователь" DataField="UserID" SortExpression="userid" ItemStyle-Width="170px"/>
                    <asp:BoundField HeaderText="Сайт" DataField="Site" SortExpression="site" ItemStyle-Width="200px"/>
                    <asp:BoundField HeaderText="Ссылка на сайте" DataField="Url" SortExpression="url"/>
                </Columns>
                <EmptyDataTemplate>
                    <b>
