        ...
        protected void btnSend_Click(object sender, EventArgs e)
        {
            ...
            if (newsletters.Count > 0)
            {
                ...
                else
                {
                    ...
                    Newsletter.SendNoSendingNewsletters("Новости от С-СLIMATE.RU", Request.PhysicalApplicationPath + "newsletter.txt", Request.PhysicalApplicationPath + "newsletters.txt",
