...
namespace UC.UI
{
    public partial class RefreshProduct : BasePage
    {
        int _productID = 0;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!this.IsPostBack)
            {
                ...
                ParsingProduct product = ParsingProduct.GetProductByID(CatalogID, ProductID, ParsingCatalog.GetProviderTypeByID(CatalogID));
                ...
                lnkRefreshCatalogTitle.Text = "Обновление " + catalog.Title;
                lnkRefreshCatalogTitle.NavigateUrl = "~/Admin/RefreshParsingCatalog.aspx?CatalogID=" + CatalogID.ToString();
