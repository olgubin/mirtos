<%@ Page Language="C#" MasterPageFile="Admin.master" ValidateRequest="false"
    AutoEventWireup="true" CodeFile="ManageParsingProduct.aspx.cs" Inherits="UC.UI.ManageParsingProduct"
                    ...
                    <table>
                        <tr>
                            ...
                            <td>
                                ...
                                <p><b style="color: #d7c5ab;">Краткое описание:</b></p>
                                <asp:Literal runat="server" ID="lblShortDescription" />                                
                                <p><b style="color: #d7c5ab;">Полное описание:</b></p>
