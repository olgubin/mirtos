...
<asp:Content ID="MainContent" ContentPlaceHolderID="MainContent" Runat="Server">   
    <div class="breadcrumb">
        <div class="breadcrumb_middle">
            <table>
                <tr>
                    <td>
                        <a href="../Default.aspx">Климатическое оборудование</a></td>
                    <td>
                        <img src="Images/angle_b.gif" alt="->"/> 
                    
                    </td>
                    <td><a href="Default.aspx">Администрирование</a></td>
                    <td>
                        <img src="Images/angle_b.gif" alt="->"/> 
                    
                    </td>
                    <td><h1>Управление темами статей</h1></td>                    
                </tr>
            </table>
        </div>    
   ...
   <asp:GridView ID="gvwCategories" runat="server" AutoGenerateColumns="False" DataSourceID="objAllCategories" Width="100%" DataKeyNames="ID" OnRowDeleted="gvwCategories_RowDeleted" OnRowCreated="gvwCategories_RowCreated" OnSelectedIndexChanged="gvwCategories_SelectedIndexChanged" ShowHeader="false">
      <Columns>
         ...
         <asp:CommandField ButtonType="Image" SelectImageUrl="~/Images/Edit.gif" SelectText="Редактировать тему" ShowSelectButton="True">
            <ItemStyle HorizontalAlign="Center" Width="20px" />
         </asp:CommandField>
         <asp:CommandField ButtonType="Image" DeleteImageUrl="~/Images/Delete.gif" DeleteText="Удалить тему" ShowDeleteButton="True">
            <ItemStyle HorizontalAlign="Center" Width="20px" />
         </asp:CommandField>
      </Columns>
      <EmptyDataTemplate><b>Тем нет</b></EmptyDataTemplate>   
   </asp:GridView>
   ...
   <p></p>
   <asp:DetailsView ID="dvwCategory" runat="server" AutoGenerateRows="False" DataSourceID="objCurrCategory" Height="50px" Width="50%" AutoGenerateEditButton="True" AutoGenerateInsertButton="True" HeaderText="Редактирование темы" OnItemInserted="dvwCategory_ItemInserted" OnItemUpdated="dvwCategory_ItemUpdated" DataKeyNames="ID" OnItemCreated="dvwCategory_ItemCreated" DefaultMode="Insert" OnItemCommand="dvwCategory_ItemCommand">
      ...
      <Fields>
         ...
         <asp:BoundField DataField="AddedBy" HeaderText="Добавлена" InsertVisible="False" ReadOnly="True"
         ...
         <asp:TemplateField HeaderText="Важность" SortExpression="Importance">
            <ItemTemplate>
         ...
         <asp:TemplateField HeaderText="Картинка" ConvertEmptyStringToNull="False">
            <ItemTemplate>
