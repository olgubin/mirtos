            ...
            <table cellpadding="5" style="width: 100%;padding-bottom:7px">
                <tr>
                    <td style="width: 120px">
                        <div>
                            <asp:HyperLink runat="server" ID="lnkDepImage" NavigateUrl='<%# SeoHelper.GetAbsoluteUrl(this.ResolveUrl("~/Departments.aspx?DepID=" + Eval("DepartmentID"))) %>'
                                ToolTip='<%# Eval("Name") %>'>
                    ...
                    <td style="width: 100%">
                        <div class="departmenttitle" style="padding-top:0px">
                                <asp:HyperLink runat="server" ID="HyperLink2" Text='<%# Eval("Name") %>' NavigateUrl='<%# SeoHelper.GetAbsoluteUrl(this.ResolveUrl("~/Departments.aspx?DepID=" + Eval("DepartmentID"))) %>' />
                        </div>                    
                        <div class="departmentdescription" style="text-align:justify">
                        <asp:HyperLink runat="server" ID="HyperLink1" NavigateUrl='<%# SeoHelper.GetAbsoluteUrl(this.ResolveUrl("~/Departments.aspx?DepID=" + Eval("DepartmentID"))) %>' ToolTip='<%# Eval("Name") %>'><%#Eval("Description")%></asp:HyperLink>
                        </div>
                    </td>
                </tr>
            </table>
