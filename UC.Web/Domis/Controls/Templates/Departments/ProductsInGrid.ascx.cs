...
{
    public partial class ProductsInGrid : BaseWebPart
    {
        int _departmentID = 0;
        ...
        protected int ProductsBind()
        {
            ...
            if (DepartmentID > 0)
            {
                ...
                if (ManufacturerID > 0)
                {
                    IEnumerable<Product> tempCollection;

                    ProductCollection products = ProductManager.GetByManufacturerID(ManufacturerID, true);

                    tempCollection = productDepartmentCollection.Select(p => p.Product);

                    //productCollection = tempCollection.Intersect(products);

                    productCollection = tempCollection.Join(products, e => e.ProductID, o => o.ProductID, (e, o) => e);
                }
                else
                {
        ...
        {
            lbtn10.ForeColor = System.Drawing.ColorTranslator.FromHtml("#ee8d9e");
            lbtn10.BackColor = System.Drawing.Color.White;
            lbtn20.ForeColor = System.Drawing.ColorTranslator.FromHtml("#ee8d9e");
            lbtn20.BackColor = System.Drawing.Color.White;
            lbtn30.ForeColor = System.Drawing.ColorTranslator.FromHtml("#ee8d9e");
            lbtn30.BackColor = System.Drawing.Color.White;
            lbtn40.ForeColor = System.Drawing.ColorTranslator.FromHtml("#ee8d9e");
            lbtn40.BackColor = System.Drawing.Color.White;
            lbtn50.ForeColor = System.Drawing.ColorTranslator.FromHtml("#ee8d9e");
                ...
                case 10:
                    {
                        ...
                        lbtn10.BackColor = System.Drawing.ColorTranslator.FromHtml("#ee8d9e");
                        MaximumRow = 10;
                        break;
                    }
                case 20:
                    {
                        ...
                        lbtn20.BackColor = System.Drawing.ColorTranslator.FromHtml("#ee8d9e");
                        MaximumRow = 20;
                        break;
                    }
                case 30:
                    {
                        ...
                        lbtn30.BackColor = System.Drawing.ColorTranslator.FromHtml("#ee8d9e");
                        MaximumRow = 30;
                        break;
                    }
                case 40:
                    {
                        ...
                        lbtn40.BackColor = System.Drawing.ColorTranslator.FromHtml("#ee8d9e");
                        MaximumRow = 40;
                        break;
                    }
                case 50:
                    {
                        ...
                        lbtn50.BackColor = System.Drawing.ColorTranslator.FromHtml("#ee8d9e");
                        MaximumRow = 50;
                        break;
                    }
            }
