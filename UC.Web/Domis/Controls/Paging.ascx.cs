...
namespace UC.UI.Controls
{
    ...
    public partial class Paging : System.Web.UI.UserControl
    {
        ...
        public void PagingRender()
        {
            ...
            lnkPrevTop.NavigateUrl = SeoHelper.GetAbsoluteUrl(this.ResolveUrl(SEOHelper.SeoHelper.GetUrl(BrowseUrl,PageIndex - 1)));
            lnkNextTop.Visible = (PagesCount - 1) < 0 ? false : (PageIndex != PagesCount);
            //lnkNextTop.NavigateUrl = BrowseUrl + "p=" + (PageIndex + 1).ToString();
            lnkNextTop.NavigateUrl = SeoHelper.GetAbsoluteUrl(this.ResolveUrl(SEOHelper.SeoHelper.GetUrl(BrowseUrl, PageIndex + 1)));
        }
            ...
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                if (lnk != null)
                {
                    if (((PagingPage)e.Item.DataItem).PageNumber != PageIndex)
                    {
                        ...
                        lnk.NavigateUrl = SeoHelper.GetAbsoluteUrl(this.ResolveUrl(SEOHelper.SeoHelper.GetUrl(BrowseUrl, ((PagingPage)e.Item.DataItem).PageNumber)));
                    }
                }
            }
        }
