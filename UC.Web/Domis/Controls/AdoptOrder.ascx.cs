    ...
    public partial class AdoptOrder : System.Web.UI.UserControl
    {
        ...
        public void Generate()
        {
            if (Page.User.Identity.IsAuthenticated)
            {
                ...
                prim = prim + "</p>";
                prim = prim + "<p>Вопросы, связанные с заказами, а также предложения и пожелания по работе магазина и службы доставки Вы можите направлять по адресу: <a href=\"mailto:" + SettingManager.GetSettingValue("Common.ZakazTo") + "\">" + SettingManager.GetSettingValue("Common.ZakazTo") + "</a>. Для нас важно знать Ваше мнение!</p><p><b style=\"color: #9aaab1\">Спасибо, что Вы выбрали нас!</b></p>";
                ...
                try
                {
                    ...
                    message.To.Add(SettingManager.GetSettingValue("Common.MailTo"));
