<%@ Page Language="C#" ValidateRequest="false" MasterPageFile="~/Template.master" AutoEventWireup="true" CodeFile="AddEditPost.aspx.cs" Inherits="UC.UI.AddEditPost" Title="The Beer House - Add/Edit Post" %>
...
<asp:Content ID="MainContent" ContentPlaceHolderID="MainContent" Runat="Server">
   ...
   <asp:Panel runat="server" ID="panInput">
      ...
      <fckeditorv2:fckeditor id="txtBody" runat="server" ToolbarSet="UC_Simple" Height="400px" Width="99%" />
      <p></p>
