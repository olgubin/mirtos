    ...
    public partial class ArticlesCategories : BasePage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!this.IsPostBack)
            {
                ...
                BasePage.HeaderWrite(this.Page, "Статьи мебели для ванной и душевых кабинах",
                    "статьи, мебель для ванной, мебель для ванной, мебель для ванной Edelform, душевые кабины, душевые кабины Edelform, душевые кабины Luxus",
                    "Статьи о мебели для ванной, дизайне ванной и душевых кабинах.");
            }
        }

        // Привязка дочерней таблицы к источнику данных
