...
namespace UC.UI
{
    public partial class ShowNewsletter : BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            BreadCrumb.AddActiveLink("Новости", SeoHelper.GetAbsoluteUrl(this.ResolveUrl("~/Newsletters.aspx")));
            ...
            else
            {
                ...
                if (!this.IsPostBack)
                {
                    ...
                    BasePage.HeaderWrite(this.Page, newsletter.Subject,
                        newsletter.Subject + ", новости, мебель для ванной, мебель для ванной Edelform, душевые кабины, душевые кабины Edelform, душевые кабины Luxus",
                        newsletter.Abstract);
                }
