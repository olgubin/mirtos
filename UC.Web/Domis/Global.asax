...
<script RunAt="server">
    ...
    void Application_Error(Object sender, EventArgs e)
    {
        ...
        //    message.From = new MailAddress("error@DOMIS.RU", "Ошибка в работе DOMIS.RU", System.Text.Encoding.UTF8);
        //    message.IsBodyHtml = false;
        //    message.Subject = "Отчет об ошибке на DOMIS.RU";
        ...
        //    message.To.Add("ogubin@DOMIS.RU");
