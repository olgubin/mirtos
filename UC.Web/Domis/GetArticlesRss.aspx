<%@ Page Language="C#" AutoEventWireup="true" ContentType="text/xml" MaintainScrollPositionOnPostback="false" EnableTheming="false" CodeFile="GetArticlesRss.aspx.cs" Inherits="UC.UI.GetArticlesRss" %>
...
<asp:Repeater id="rptRss" runat="server">
   ...
   <ItemTemplate>
      <item>
         ...
         <link><![CDATA[<%# FullBaseUrl + "Article.aspx?ID=" + Eval("ID") %>]]></link>
