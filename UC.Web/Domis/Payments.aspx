...
<mb:BreadCrumb ID="BreadCrumb" runat="server" />
    <div id="content">
        ...
        <ul>
            <p>
                Заказ оплачивается в момент получения товара. Оплата производится только в рублях.</p>
        </ul>
        <h3>
            Безналичный:</h3>
        <ul>
                ...
                <p>
                    ...
                    <p>
                        ...
                        <p>
                            ...
                            в вашем банке.
                            <p>
                                После внесения оплаты, просьба выслать копию квитанции на почту <a href="mailto:zakaz@domis.ru">zakaz@domis.ru</a> или по факсу.
                                    ...
                                    <p>
                                        ...
                                        <p>
                                            ...
                                            <p>
                                                ...
                                                <p>
        После внесения оплаты, просьба выслать копию Платежного поручения на почту <a href="mailto:zakaz@domis.ru">zakaz@domis.ru</a> или по факсу.
    </div>
</asp:Content>
