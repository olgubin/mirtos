        ...
        <asp:MultiView ID="mvwSubmitOrder" runat="server">
            ...
            <asp:View ID="vwRegister" runat="server">
                ...
                <table style="width: 100%">
                    <tr>
                        <td style="background-color: #fef7f8; border: solid 1px white; padding: 7px;">
                        ...
                        <td style="width: 200px; background-color: #fef7f8; padding: 7px; border: solid 1px white;">
                ...
                <asp:Panel ID="Panel1" runat="server" DefaultButton="btnRegister">
                    <mb:Register runat="server" ID="Reg" BodyFileName="~/RegistrationMail.txt" From="info@domis.ru"
                        FromCaption="DOMIS.RU Мебель для ванной, душевые кабины" Subject="Регистрационные данные"
