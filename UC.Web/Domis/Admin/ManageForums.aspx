<%@ Page Language="C#" MasterPageFile="Admin.master" ValidateRequest="false" AutoEventWireup="true" CodeFile="ManageForums.aspx.cs" Inherits="UC.UI.Admin.ManageForums" Title="The Beer House - Manage Forums" %>
<asp:Content ID="MainContent" ContentPlaceHolderID="MainContent" Runat="Server">   
   ...
   <asp:ObjectDataSource ID="objAllForums" runat="server" SelectMethod="GetForums"
      TypeName="UC.BLL.Forums.Forum" DeleteMethod="DeleteForum">
   ...
   <asp:ObjectDataSource ID="objCurrForum" runat="server" InsertMethod="InsertForum" SelectMethod="GetForumByID" TypeName="UC.BLL.Forums.Forum" UpdateMethod="UpdateForum">
      <SelectParameters>
