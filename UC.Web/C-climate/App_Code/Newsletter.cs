...
namespace UC.BLL.Newsletters
{
    ...
    public class Newsletter : BizObject
    {
        ...
        public bool Update()
        {
            return Newsletter.UpdateNewsletter(this.ID, this.AddedDate.ToShortDateString(), this.Subject, this.Abstract, this.HtmlBody);
        }
        ...
        ************************************/
        ...
        /// </summary>
        public static bool UpdateNewsletter(int id, string addedDate, string subject, string Abstract, string htmlBody)
        {
            ...
            {
                date = DateTime.Parse(addedDate);
            }

            NewsletterDetails record = new NewsletterDetails(id, date, "", subject, Abstract, htmlBody, false);
        ...
        /// Добалвяет новость
        /// </summary>
        public static int InsertNewsletter(string addedDate, string subject, string Abstract, string htmlBody)
        {
            DateTime date = DateTime.Now;
            ...
            NewsletterDetails record = new NewsletterDetails(0, date, BizObject.CurrentUserName, subject, Abstract, htmlBody, false);
