<%@ Page Language="C#" MasterPageFile="~/Template.master" AutoEventWireup="true" CodeFile="ShoppingCart.aspx.cs" Inherits="UC.UI.ShoppingCart" Culture="auto" UICulture="auto" MaintainScrollPositionOnPostback="true" %>
...
<%@ Register Src="Controls/OneClickOrderControl.ascx" TagName="OneClickOrderControl" TagPrefix="mb" %>    
<asp:Content ID="MainContent" ContentPlaceHolderID="MainContent" runat="Server">
    <mb:OneClickOrderControl ID="OneClickOrderControl" runat="server"/>
<%--    <div id="content">
        <asp:MultiView ID="mvwSubmitOrder" runat="server">
            <asp:View ID="vwEmptyCart" runat="server">
                ...
                <p>
                    Вы можите выбрать товар, воспользовавшись нашим 
                    <asp:HyperLink runat="server" NavigateUrl="~/">каталогом</asp:HyperLink>.</p>
                <p>
                    Для наполнения корзины необходимо выбрать товар в <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/">каталоге</asp:HyperLink>, указать количество и нажать на кнопку "Купить".</p>
            </asp:View>
            <asp:View ID="vwRegister" runat="server">
                <p style="font-weight: bold; color: #9aaab1">
                    Для зарегистрированных покупателей</p>
                <table style="width: 100%">
                    <tr>
                        <td style="background-color: #f1f4f5; border: solid 1px white; padding: 7px;">
                        ...
                        <td style="width: 200px; background-color: #f1f4f5; padding: 7px; border: solid 1px white;">
                ...
                <asp:Panel ID="Panel1" runat="server" DefaultButton="btnRegister">
                    <mb:Register runat="server" ID="Reg" BodyFileName="~/RegistrationMail.txt" From="info@MIRTOS.RU"
                        FromCaption="MIRTOS.RU Климатическое оборудование" Subject="Регистрационные данные"
