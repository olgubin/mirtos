    ...
    <div id="content">
        ...
        <table style="width: 100%" cellpadding="2px">
            ...
            <tr>
                ...
                <td>
                    <mb:EmailTextBox runat="server" CssClass="adminInput" ID="txtMailFrom" Width="99%">
                    </mb:EmailTextBox>
                </td>
            </tr>
            <tr>
                <td>
                    Отправка заказов с адреса:
                </td>
                <td>
                    <mb:EmailTextBox runat="server" CssClass="adminInput" ID="txtZakazFrom" Width="99%">
                    </mb:EmailTextBox>
                </td>
            </tr>            
            <tr>
                <td>
                    Адреса для приема заказов:
                </td>
                <td>
