...
namespace UC.UI.Admin
{
    public partial class CommonSettings : BasePage
    {
        ...
        private void BindData()
        {
            ...
            txtMailFrom.Text = SettingManager.GetSettingValue("Common.MailFrom");
            txtZakazFrom.Text = SettingManager.GetSettingValue("Common.ZakazFrom");
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            if (Page.IsValid)
            {
                try
                {
                    ...
                    SettingManager.SetParam("Common.MailFrom", txtMailFrom.Text, string.Empty);
                    SettingManager.SetParam("Common.ZakazFrom", txtZakazFrom.Text, string.Empty);
