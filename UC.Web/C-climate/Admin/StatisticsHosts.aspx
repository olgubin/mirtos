...
<b>Адреса не учитываемые в статистике</b>
        ...
        <td>
            <asp:GridView ID="gvwHosts" runat="server" AllowPaging="true" AutoGenerateColumns="False"
                DataKeyNames="IP" DataSourceID="objHosts" AllowSorting="true" EmptyDataText="<b>Нет данных</b>" 
        ...
        <td style="padding-left:7px">
            ...
            DefaultMode="Insert" OnItemCommand="dvwIgnoreHosts_ItemCommand" OnItemInserted="dvwIgnoreHosts_ItemInserted" OnItemUpdated="dvwIgnoreHosts_ItemUpdated" OnItemCreated="dvwIgnoreHosts_ItemCreated">
               ...
               <Fields>
                  ...
                  <asp:CheckBoxField DataField="Block" HeaderText="Блокировать" />
               </Fields>
            </asp:DetailsView>
            ...
            <asp:GridView ID="gvwIgnoreHosts" runat="server" AutoGenerateColumns="False" AllowSorting="true" AllowPaging="true" PageSize="40" DataSourceID="objIgnoreHosts" DataKeyNames="IP"
               ...
               <Columns>
                  <asp:BoundField DataField="IP" HeaderText="IP адрес" SortExpression="IP"></asp:BoundField>
                  <asp:BoundField DataField="Comment" HeaderText="Комментарий" SortExpression="Comment">
                     <ItemStyle HorizontalAlign="Justify" />
                  </asp:BoundField>
                    <asp:BoundField DataField="DateAdd" HeaderText="Дата блокировки" DataFormatString="{0:dd/MM/yy}" SortExpression="DateAdd">
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:BoundField>                    
                    <asp:BoundField DataField="DateLast" HeaderText="Последняя активность" DataFormatString="{0:dd/MM/yy}" SortExpression="DateLast">
                        <ItemStyle HorizontalAlign="Center" />
                    </asp:BoundField>
<%--<asp:TemplateField>
    <ItemTemplate>
