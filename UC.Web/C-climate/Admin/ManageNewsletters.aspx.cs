        ...
        protected void btnSend_Click(object sender, EventArgs e)
        {
            ...
            if (newsletters.Count > 0)
            {
                ...
                else
                {
                    ...
                    Newsletter.SendNoSendingNewsletters("Новости от MIRTOS.RU", Request.PhysicalApplicationPath + "newsletter.txt", Request.PhysicalApplicationPath + "newsletters.txt",
