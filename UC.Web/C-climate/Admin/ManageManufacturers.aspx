...
<%@ Register Src="~/Admin/Controls/ManufacturerFiltersControl.ascx" TagName="ManufacturerFiltersControl"
    TagPrefix="mb" %>
<%@ Register Src="~/Admin/Controls/ManufacturerLongDescriptionControl.ascx" TagName="ManufacturerLongDescriptionControl"
    TagPrefix="mb" %>    
                    ...
                    <tr>
                        ...
                        <td>
                            <ajaxToolkit:TabContainer runat="server" ID="ManufacturerTabs" ActiveTabIndex="0"
                                ...
                                <ajaxToolkit:TabPanel runat="server" ID="pnlManufacturerLongDescription" HeaderText="Расширенное описание"
                                    Width="100%">
                                    <ContentTemplate>
                                        <mb:ManufacturerLongDescriptionControl ID="ManufacturerLongDescriptionControl" runat="server" />
                                    </ContentTemplate>
                                </ajaxToolkit:TabPanel>                                
