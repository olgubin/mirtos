<%@ Page Language="C#" MasterPageFile="~/Template.master" AutoEventWireup="true" CodeFile="BrowseThreads.aspx.cs" Inherits="UC.UI.BrowseThreads" Title="The Beer House - Browse Threads: {0}" %>
...
<asp:Content ID="MainContent" ContentPlaceHolderID="MainContent" Runat="Server">
   <div class="sectiontitle">
      ...
      <asp:DropDownList ID="ddlForums" runat="server" DataSourceID="objForums" DataTextField="Title" DataValueField="ID"
         ...
         TypeName="UC.BLL.Forums.Forum"></asp:ObjectDataSource>
   </div>
   <p></p>
   ...
   <asp:ObjectDataSource ID="objThreads" runat="server" DeleteMethod="DeletePost" SelectMethod="GetThreads" SelectCountMethod="GetThreadCount"
      TypeName="UC.BLL.Forums.Post" EnablePaging="true" SortParameterName="sortExpression">
      <DeleteParameters>
