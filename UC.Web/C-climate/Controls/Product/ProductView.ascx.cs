...
namespace UC.UI.Controls
{
    public partial class ProductView : BaseWebPart
    {
        ...
        public decimal UnitPrice
        {
            get 
            {
                return CurrencyManager.ConvertCurrency(_unitPrice, CurrencyManager.GetByCurrencyID(_currencyID), CurrencyManager.WorkingCurrency);
            }
            set { _unitPrice = value; }
        }

        private decimal _FinalPrice = 0.0m;
        public decimal FinalPrice
        {
            get 
            {
                return CurrencyManager.ConvertCurrency(_FinalPrice, CurrencyManager.GetByCurrencyID(_currencyID), CurrencyManager.WorkingCurrency); 
            }
