    ...
    <tr>
        <td style="padding-right: 3px">
            <asp:HyperLink runat="server" ID="HyperLink2" NavigateUrl='<%# SeoHelper.GetAbsoluteUrl(this.ResolveUrl("~/ShowProduct.aspx?ID=" + ProductID)) %>'
                ...
                <asp:Image runat="server" ID="Image2" BorderWidth="1px" GenerateEmptyAlternateText="true" ImageUrl='<%# SeoHelper.GetAbsoluteUrl(this.ResolveUrl("~/smallimage.aspx?ID=" + ProductID)) %>' Width="100px" Height="100px" BorderColor="#9aaab1" />
            </asp:HyperLink>
            <div class="rait">
