      ...
      public int Value
      {
         ...
         set
         {
            ...
            if (_value <= 0)
            {
               ...
               imgAvailability.AlternateText = (string)GetLocalResourceObject("String1");
            }
            else if (_value <= Globals.Settings.Store.LowAvailability)
            {
               imgAvailability.ImageUrl = "~/images/lightyellow.gif";
               imgAvailability.AlternateText = (string)GetLocalResourceObject("String2");
            }
            else
            {
               imgAvailability.ImageUrl = "~/images/lightgreen.gif";
               imgAvailability.AlternateText = (string)GetLocalResourceObject("String3");
            }
         }
      }
