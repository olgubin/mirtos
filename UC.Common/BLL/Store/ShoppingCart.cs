...
namespace UC.BLL.Store
{
    ...
    public class ShoppingCartItem
    {
        ...
        public ShoppingCartItem(int id, string title, string sku, decimal unitPrice, int quantity)
        {
            this.ID = id;
            this.Title = title;
            this.SKU = sku;
    ...
    public class ShoppingCart
    {
        ...
        public void InsertItem(int id, string title, string sku, decimal unitPrice, int quantity)
        {
            if (_items.ContainsKey(id))
            {
            ...
            {
                _items.Add(id, new ShoppingCartItem(id, title, sku, unitPrice, quantity));
            }
        }
