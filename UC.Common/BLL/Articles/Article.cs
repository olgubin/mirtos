...
namespace UC.BLL.Articles
{
    public class Article : BaseArticle
    {
        ...
        ************************************/
        ...
        /// </summary>      
        public static List<Article> GetArticlesLast(int count)
        {
            List<Article> articles = null;
            string key = "Articles_ArticlesLast_" + count.ToString();
            ...
            {
                List<ArticleDetails> recordset = SiteProvider.Articles.GetArticlesLast(count);
                articles = GetArticleListFromArticleDetailsList(recordset);
        ...
        /// Возвращает последние статьи
        /// </summary>      
        public static List<Article> GetArticlesLast(int count, int categoryID)
        {
            List<Article> articles = null;
            string key = "Articles_ArticlesLast_" + categoryID.ToString() + "_" + count.ToString();
            ...
            {
                List<ArticleDetails> recordset = SiteProvider.Articles.GetArticlesLast(count, categoryID);
                articles = GetArticleListFromArticleDetailsList(recordset);
                CacheData(key, articles);
            }
            return articles;
        ...
        /// <summary>
        /// Возвращает коллекцию всех опубликованных статей в указанной категории постранично
        /// </summary>
        ...
        private static Article GetArticleFromArticleDetails(ArticleDetails record)
        {
            ...
            else
            {
                return new Article(record.ID, record.AddedDate, record.AddedBy,
                   ...
                   record.ReleaseDate, record.ExpireDate, record.Approved, record.Listed, record.CommentsEnabled, record.OnlyForMembers,
