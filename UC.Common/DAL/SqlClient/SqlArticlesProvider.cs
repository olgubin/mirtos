...
namespace UC.DAL.SqlClient
{
    public class SqlArticlesProvider : ArticlesProvider
    {
        ...
        public override List<CategoryDetails> GetCategories()
        {
            ...
            {
                SqlCommand cmd = new SqlCommand("sh_Articles_GetCategories", cn);
        ...
        public override CategoryDetails GetCategoryByID(int categoryID)
        {
            using (SqlConnection cn = new SqlConnection(this.ConnectionString))
            {
                SqlCommand cmd = new SqlCommand("sh_Articles_GetCategoryByID", cn);
                cmd.CommandType = CommandType.StoredProcedure;
        ...
        public override bool DeleteCategory(int categoryID)
        {
            using (SqlConnection cn = new SqlConnection(this.ConnectionString))
            {
                SqlCommand cmd = new SqlCommand("sh_Articles_DeleteCategory", cn);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.Add("@CategoryID", SqlDbType.Int).Value = categoryID;
                cn.Open();
        ...
        public override bool UpdateCategory(CategoryDetails category)
        {
            using (SqlConnection cn = new SqlConnection(this.ConnectionString))
            {
                SqlCommand cmd = new SqlCommand("sh_Articles_UpdateCategory", cn);
                cmd.CommandType = CommandType.StoredProcedure;
        ...
        public override int InsertCategory(CategoryDetails category)
        {
            using (SqlConnection cn = new SqlConnection(this.ConnectionString))
            {
                SqlCommand cmd = new SqlCommand("sh_Articles_InsertCategory", cn);
                cmd.CommandType = CommandType.StoredProcedure;
        ...
        public override List<ArticleDetails> GetArticles(int pageIndex, int pageSize)
        {
            using (SqlConnection cn = new SqlConnection(this.ConnectionString))
            {
                SqlCommand cmd = new SqlCommand("sh_Articles_GetArticles", cn);
                cmd.CommandType = CommandType.StoredProcedure;
        ...
        public override int GetArticleCount()
        {
            using (SqlConnection cn = new SqlConnection(this.ConnectionString))
            {
                SqlCommand cmd = new SqlCommand("sh_Articles_GetArticleCount", cn);
                cmd.CommandType = CommandType.StoredProcedure;
                cn.Open();
        ...
        public override List<ArticleDetails> GetArticles(int categoryID, int pageIndex, int pageSize)
        {
            using (SqlConnection cn = new SqlConnection(this.ConnectionString))
            {
                SqlCommand cmd = new SqlCommand("sh_Articles_GetArticlesByCategory", cn);
                cmd.Parameters.Add("@CategoryID", SqlDbType.Int).Value = categoryID;
                cmd.Parameters.Add("@PageIndex", SqlDbType.Int).Value = pageIndex;
                cmd.Parameters.Add("@PageSize", SqlDbType.Int).Value = pageSize;
                cmd.CommandType = CommandType.StoredProcedure;
        ...
        public override int GetArticleCount(int categoryID)
        {
            using (SqlConnection cn = new SqlConnection(this.ConnectionString))
            {
                SqlCommand cmd = new SqlCommand("sh_Articles_GetArticleCountByCategory", cn);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.Add("@CategoryID", SqlDbType.Int).Value = categoryID;
                cn.Open();
                return (int)ExecuteScalar(cmd);
        ...
        /// <summary>
        /// Возвращает указанное количество последних статей
        /// </summary>
        public override List<ArticleDetails> GetArticlesLast(int count)
        {
            using (SqlConnection cn = new SqlConnection(this.ConnectionString))
            {
                SqlCommand cmd = new SqlCommand("sh_Articles_GetArticlesLast", cn);
                cmd.CommandType = CommandType.StoredProcedure;
        ...
        /// Возвращает указанное количество последних статей
        /// </summary>
        public override List<ArticleDetails> GetArticlesLast(int count, int categoryID)
        {
            using (SqlConnection cn = new SqlConnection(this.ConnectionString))
            {
                SqlCommand cmd = new SqlCommand("sh_Articles_GetArticlesLastByCategory", cn);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.Add("@Count", SqlDbType.Int).Value = count;
                cmd.Parameters.Add("@CategoryID", SqlDbType.Int).Value = categoryID;
                cn.Open();
        ...
        public override List<ArticleDetails> GetPublishedArticles(DateTime currentDate, int pageIndex, int pageSize)
        {
            using (SqlConnection cn = new SqlConnection(this.ConnectionString))
            {
                SqlCommand cmd = new SqlCommand("sh_Articles_GetPublishedArticles", cn);
                cmd.CommandType = CommandType.StoredProcedure;
        ...
        public override int GetPublishedArticleCount(DateTime currentDate)
        {
            using (SqlConnection cn = new SqlConnection(this.ConnectionString))
            {
                SqlCommand cmd = new SqlCommand("sh_Articles_GetPublishedArticleCount", cn);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.Add("@CurrentDate", SqlDbType.DateTime).Value = currentDate;
                cn.Open();
                return (int)ExecuteScalar(cmd);
        ...
        public override List<ArticleDetails> GetPublishedArticles(int categoryID, DateTime currentDate, int pageIndex, int pageSize)
        {
            using (SqlConnection cn = new SqlConnection(this.ConnectionString))
            {
                SqlCommand cmd = new SqlCommand("sh_Articles_GetPublishedArticlesByCategory", cn);
                cmd.Parameters.Add("@CategoryID", SqlDbType.Int).Value = categoryID;
                cmd.Parameters.Add("@CurrentDate", SqlDbType.DateTime).Value = currentDate;
                cmd.Parameters.Add("@PageIndex", SqlDbType.Int).Value = pageIndex;
                cmd.Parameters.Add("@PageSize", SqlDbType.Int).Value = pageSize;
        ...
        public override int GetPublishedArticleCount(int categoryID, DateTime currentDate)
        {
            using (SqlConnection cn = new SqlConnection(this.ConnectionString))
            {
                SqlCommand cmd = new SqlCommand("sh_Articles_GetPublishedArticleCountByCategory", cn);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.Add("@CategoryID", SqlDbType.Int).Value = categoryID;
                cmd.Parameters.Add("@CurrentDate", SqlDbType.DateTime).Value = currentDate;
                cn.Open();
        ...
        public override ArticleDetails GetArticleByID(int articleID)
        {
            using (SqlConnection cn = new SqlConnection(this.ConnectionString))
            {
                SqlCommand cmd = new SqlCommand("sh_Articles_GetArticleByID", cn);
                cmd.CommandType = CommandType.StoredProcedure;
        ...
        public override string GetArticleBody(int articleID)
        {
            using (SqlConnection cn = new SqlConnection(this.ConnectionString))
            {
                SqlCommand cmd = new SqlCommand("sh_Articles_GetArticleBody", cn);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.Add("@ArticleID", SqlDbType.Int).Value = articleID;
                cn.Open();
        ...
        public override bool DeleteArticle(int articleID)
        {
            using (SqlConnection cn = new SqlConnection(this.ConnectionString))
            {
                SqlCommand cmd = new SqlCommand("sh_Articles_DeleteArticle", cn);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.Add("@ArticleID", SqlDbType.Int).Value = articleID;
                cn.Open();
                int ret = ExecuteNonQuery(cmd);
        ...
        public override int InsertArticle(ArticleDetails article)
        {
            using (SqlConnection cn = new SqlConnection(this.ConnectionString))
            {
                SqlCommand cmd = new SqlCommand("sh_Articles_InsertArticle", cn);
                cmd.CommandType = CommandType.StoredProcedure;
        ...
        public override bool UpdateArticle(ArticleDetails article)
        {
            using (SqlConnection cn = new SqlConnection(this.ConnectionString))
            {
                SqlCommand cmd = new SqlCommand("sh_Articles_UpdateArticle", cn);
                cmd.CommandType = CommandType.StoredProcedure;
        ...
        public override bool ApproveArticle(int articleID)
        {
            using (SqlConnection cn = new SqlConnection(this.ConnectionString))
            {
                SqlCommand cmd = new SqlCommand("sh_Articles_ApproveArticle", cn);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.Add("@ArticleID", SqlDbType.Int).Value = articleID;
                cn.Open();
                int ret = ExecuteNonQuery(cmd);
        ...
        public override bool IncrementArticleViewCount(int articleID)
        {
            using (SqlConnection cn = new SqlConnection(this.ConnectionString))
            {
                SqlCommand cmd = new SqlCommand("sh_Articles_IncrementViewCount", cn);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.Add("@ArticleID", SqlDbType.Int).Value = articleID;
                cn.Open();
                int ret = ExecuteNonQuery(cmd);
        ...
        public override bool RateArticle(int articleID, int rating)
        {
            using (SqlConnection cn = new SqlConnection(this.ConnectionString))
            {
                SqlCommand cmd = new SqlCommand("sh_Articles_InsertVote", cn);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.Add("@ArticleID", SqlDbType.Int).Value = articleID;
        ...
        public override List<CommentDetails> GetComments(int pageIndex, int pageSize)
        {
            using (SqlConnection cn = new SqlConnection(this.ConnectionString))
            {
                SqlCommand cmd = new SqlCommand("sh_Articles_GetComments", cn);
                cmd.Parameters.Add("@PageIndex", SqlDbType.Int).Value = pageIndex;
                cmd.Parameters.Add("@PageSize", SqlDbType.Int).Value = pageSize;
                cmd.CommandType = CommandType.StoredProcedure;
                cn.Open();
        ...
        public override int GetCommentCount()
        {
            using (SqlConnection cn = new SqlConnection(this.ConnectionString))
            {
                SqlCommand cmd = new SqlCommand("sh_Articles_GetCommentCount", cn);
                cmd.CommandType = CommandType.StoredProcedure;
                cn.Open();
                return (int)ExecuteScalar(cmd);
            }
        ...
        public override List<CommentDetails> GetComments(int articleID, int pageIndex, int pageSize)
        {
            using (SqlConnection cn = new SqlConnection(this.ConnectionString))
            {
                SqlCommand cmd = new SqlCommand("sh_Articles_GetCommentsByArticle", cn);
                cmd.Parameters.Add("@ArticleID", SqlDbType.Int).Value = articleID;
                cmd.Parameters.Add("@PageIndex", SqlDbType.Int).Value = pageIndex;
                cmd.Parameters.Add("@PageSize", SqlDbType.Int).Value = pageSize;
                cmd.CommandType = CommandType.StoredProcedure;
        ...
        public override int GetCommentCount(int articleID)
        {
            using (SqlConnection cn = new SqlConnection(this.ConnectionString))
            {
                SqlCommand cmd = new SqlCommand("sh_Articles_GetCommentCountByArticle", cn);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.Add("@ArticleID", SqlDbType.Int).Value = articleID;
                cn.Open();
                return (int)ExecuteScalar(cmd);
        ...
        public override CommentDetails GetCommentByID(int commentID)
        {
            using (SqlConnection cn = new SqlConnection(this.ConnectionString))
            {
                SqlCommand cmd = new SqlCommand("sh_Articles_GetCommentByID", cn);
                cmd.CommandType = CommandType.StoredProcedure;
        ...
        public override bool DeleteComment(int commentID)
        {
            using (SqlConnection cn = new SqlConnection(this.ConnectionString))
            {
                SqlCommand cmd = new SqlCommand("sh_Articles_DeleteComment", cn);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.Add("@CommentID", SqlDbType.Int).Value = commentID;
                cn.Open();
                int ret = ExecuteNonQuery(cmd);
        ...
        public override int InsertComment(CommentDetails comment)
        {
            using (SqlConnection cn = new SqlConnection(this.ConnectionString))
            {
                SqlCommand cmd = new SqlCommand("sh_Articles_InsertComment", cn);
                cmd.CommandType = CommandType.StoredProcedure;
        ...
        public override bool UpdateComment(CommentDetails comment)
        {
            using (SqlConnection cn = new SqlConnection(this.ConnectionString))
            {
                SqlCommand cmd = new SqlCommand("sh_Articles_UpdateComment", cn);
                cmd.CommandType = CommandType.StoredProcedure;
